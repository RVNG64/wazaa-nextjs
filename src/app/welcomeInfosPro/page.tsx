...
const profileCompletionSteps: Step[] = [
  {
    id: 'country',
    type: 'next',
    message: `Dans quel pays êtes-vous basé(e) ?`,
  },
  {
    id: 'city',
    type: 'next',
  ...
  },
  {
    id: 'website',
    type: 'next',
    message: `Quelle est l'adresse de votre site web ?`,
  },
  {
    id: 'howwemet',
    type: 'options',
...
const WelcomeInfosPro: React.FC = () => {
  ...
  const validateInput = (): boolean => {
    switch (currentStep.id) {
      ...
      case 'phone':
        ...
        break;
      case 'website':
        if (!validateWebsite(inputValue)) {
          setErrorMessage('L\'adresse du site web doit commencer par http:// ou https://.');
          return false;
        }
        break;
      default:
...
export default WelcomeInfosPro;
